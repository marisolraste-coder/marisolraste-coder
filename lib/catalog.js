...
const simpleProduct = ({ id, name, category, description, image, price, preparationTimeHours = 24 }) => ({
...
const products = [
  ...
  simpleProduct({ id: 'alfajores', name: 'Mini alfajores · caja 6', category: 'alfajores', description: 'Manjar suave entre dos galletas delicadas.', image: '/public/carta/pagina-10.webp', price: 18 }),
  simpleProduct({ id: 'brownies', name: 'Brownies artesanales', category: 'brownies', description: 'Cacao intenso y centro húmedo.', image: '/crumble-maiz-morado.png', price: 24 }),
  simpleProduct({ id: 'cheesecake-aguaymanto', name: 'Cheesecake de aguaymanto', category: 'cheesecakes', description: 'Queso crema, aguaymanto y ganache de caramelo.', image: '/public/carta/pagina-13.webp', price: 78, preparationTimeHours: 48 }),
  simpleProduct({ id: 'helado-pistacho', name: 'Helado de pistacho', category: 'helados', description: 'Cremoso, intenso y hecho artesanalmente.', image: '/public/carta/pagina-12.webp', price: 25 }),
  simpleProduct({ id: 'pie', name: 'Pie de limón', category: 'pies', description: 'Sablé francesa y merengue italiano.', image: '/public/carta/pagina-05.webp', price: 20 }),
  simpleProduct({ id: 'cuchareable', name: 'Alfajor cuchareable tradicional', category: 'cuchareables', description: 'Cremoso, elegante y listo para compartir.', image: '/public/carta/pagina-07.webp', price: 20 }),
  simpleProduct({ id: 'bocaditos', name: 'Bocaditos clásicos · caja 12', category: 'bocaditos', description: 'Pequeños detalles para cada ocasión.', image: '/public/carta/pagina-10.webp', price: 30 }),
  simpleProduct({ id: 'boutique-manjar', name: 'Manjar artesanal', category: 'boutique', description: 'Un pequeño placer para regalar o disfrutar.', image: '/public/carta/pagina-09.webp', price: 30 })
];
