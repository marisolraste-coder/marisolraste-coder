...
const recommendationOccasions = [
  { id: 'surprise', label: 'Quiero sorprender a alguien', categoryPriority: ['boxes', 'boutique', 'alfajores', 'cheesecakes'], maxServings: 12 },
  { id: 'treat', label: 'Quiero darme un gusto', categoryPriority: ['cuchareables', 'brownies', 'helados', 'alfajores', 'profiteroles', 'bocaditos'], maxServings: 2 },
  ...
  { id: 'share', label: 'Necesito algo para compartir', categoryPriority: ['bocaditos', 'brownies', 'profiteroles', 'helados', 'alfajores'], minServings: 2 },
  { id: 'elegantGift', label: 'Busco un regalo elegante', categoryPriority: ['boxes', 'boutique', 'alfajores', 'cheesecakes'], maxServings: 12 },
  { id: 'company', label: 'Necesito un pedido para mi empresa', categoryPriority: ['boxes', 'bocaditos', 'tortas', 'boutique'], minServings: 4 }
];
...
const simpleProduct = ({ id, name, category, description, image, price, preparationTimeHours = 24, servings = { min: 1, max: 1 }, occasions = [], featured = 0 }) => ({
...
const products = [
  {
    ...
    allergens: ['Gluten', 'Lácteos', 'Huevo'], servingInformation: 'Mini 6 · Mediana 15 · Grande 25 porciones', servings: { min: 6, max: 25 }, occasions: ['celebration', 'share', 'company'], featured: 5,
    options: [
  ...
  },
  {
    ...
    allergens: ['Gluten', 'Lácteos', 'Huevo'], servingInformation: 'Mini 6 · Mediana 15 · Grande 25 porciones', servings: { min: 6, max: 25 }, occasions: ['celebration', 'share', 'elegantGift'], featured: 4,
    options: [
  ...
  simpleProduct({ id: 'alfajores', name: 'Mini alfajores · caja 6', category: 'alfajores', description: 'Nuestro alfajor clásico de mantequilla.', image: '/public/carta/pagina-10.webp', price: 18, servings: { min: 1, max: 2 }, occasions: ['surprise', 'treat', 'share', 'elegantGift'], featured: 4 }),
  ...
  simpleProduct({ id: 'cheesecake-aguaymanto', name: 'Cheesecake de aguaymanto', category: 'cheesecakes', description: 'Queso crema y ganache de caramelo.', image: '/public/carta/pagina-13.webp', price: 78, preparationTimeHours: 48, servings: { min: 6, max: 8 }, occasions: ['celebration', 'share', 'elegantGift'], featured: 4 }),
  ...
  simpleProduct({ id: 'cuchareable', name: 'Alfajor cuchareable tradicional', category: 'cuchareables', description: 'Cremoso y listo para disfrutar.', image: '/public/carta/pagina-07.webp', price: 20, servings: { min: 1, max: 1 }, occasions: ['treat', 'surprise'], featured: 6 }),
  ...
  simpleProduct({ id: 'boutique-manjar', name: 'Manjar artesanal', category: 'boutique', description: 'Un pequeño placer para regalar.', image: '/public/carta/pagina-09.webp', price: 30, servings: { min: 1, max: 2 }, occasions: ['surprise', 'treat', 'elegantGift'], featured: 4 })
];
...
module.exports = { categories, products, recommendationOccasions, celebrationTypes, celebrationGuestRanges, celebrationServices, resolveCartItem };
