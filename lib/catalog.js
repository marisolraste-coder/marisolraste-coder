...
const recommendationOccasions = [
  { id: 'surprise', label: 'Quiero sorprender a alguien', categoryPriority: ['boxes', 'boutique', 'profiteroles', 'alfajores', 'cheesecakes'], maxServings: 12, limit: 6, premiumGiftOnly: true, recommendationTitle: 'Una selección para sorprender', recommendationCopy: 'Sorprender nunca había sido tan dulce.' },
...
module.exports = { categories, products, recommendationOccasions, celebrationTypes, celebrationGuestRanges, celebrationServices, giftIntentions, giftCollections, giftServices, resolveCartItem };
