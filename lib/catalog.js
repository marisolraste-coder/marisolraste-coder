...
const simpleProduct = ({ id, name, category, description, image, price, preparationTimeHours = 24, servings = { min: 1, max: 1 }, occasions = [], featured = 0, giftCollections = [], giftIntentions = [] }) => ({
  ...
  servings, occasions, featured, giftCollections, giftIntentions
});
...
const products = [
  ...
  simpleProduct({ id: 'alfajores', name: 'Mini alfajores · caja 6', category: 'alfajores', description: 'Nuestro alfajor clásico de mantequilla.', image: '/public/carta/pagina-10.webp', price: 18, servings: { min: 1, max: 2 }, occasions: ['surprise', 'treat', 'share', 'elegantGift'], featured: 4, giftCollections: ['chocolate', 'gourmet', 'personalizados'], giftIntentions: ['agradecimiento', 'pensando-en-ti', 'bienvenida', 'navidad'] }),
